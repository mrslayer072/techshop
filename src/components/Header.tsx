...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Rendered as a sibling of <header> — the header has backdrop-filter,
          which creates a containing block and would trap position:fixed
          descendants, breaking the full-screen drawer/overlay. */}
